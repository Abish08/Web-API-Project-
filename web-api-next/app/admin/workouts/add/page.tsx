  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-950">Add New Workout</h1>
          <p className="text-sm text-slate-600">Create a new workout with images and video</p>
        </div>
        <Link
          href="/admin/workouts"
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-500 mt-1">Optional: Paste a YouTube or video link</p>
          </div>
