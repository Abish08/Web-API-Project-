  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Add New Workout</h1>
          <p className="text-sm text-gray-600">Create a new workout with images and video</p>
        </div>
        <Link
          href="/admin/workouts"
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2"
                placeholder="e.g., Dumbbells, Mat, None"
              />
            </div>
          ...
          {/* Video URL */}
          <div>
            <h3 className="text-lg font-semibold text-gray-800 border-b pb-2 mb-4">Media</h3>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Optional: Paste a YouTube or video link</p>
          </div>
